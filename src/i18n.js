...
const resources = {
  en: {
    translation: {
      ...
      "You have solved the puzzle!": "You have solved the puzzle! Time: {{time}}",
  ...
  zh: {
    translation: {
      ...
      Notes: "笔记",
      "Congratulations": "恭喜！",
      "You have solved the puzzle!": "你成功解决了这道题！用时：{{time}}",
  ...
  ja: {
    translation: {
      ...
      "You have solved the puzzle!": "パズルを解決しました！時間：{{time}}",
